...
public final class SuperlogicaApiException extends Exception {
	...
	public SuperlogicaApiException(SuperLogicaEndpoint endpoint, String apiStatus, String apiMsg) {
		super(String.format("Ocorreu um erro na chamada a api do Superlógica. Endpoint: %s. Status: %s. Mensagem: %s",
